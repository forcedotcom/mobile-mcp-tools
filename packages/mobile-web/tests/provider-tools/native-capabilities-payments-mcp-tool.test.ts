...
import { PaymentsMcpTool } from '../../src/provider-tools/native-capabilities-payments-mcp-tool.js';
...
describe('PaymentsMcpTool', () => {
  let mockTelemetryService: TelemetryService;
  let tool: PaymentsMcpTool;
  ...
  beforeEach(() => {
    ...
    tool = new PaymentsMcpTool(mockTelemetryService);
  });
  ...
  describe('Tool Properties', () => {
    ...
    it('should have correct name', () => {
      expect(tool.getName()).toBe('sfmobile-web-payments');
    });
  });
  ...
  describe('Tool Configuration', () => {
    it('should have correct configuration', () => {
      ...
      expect(config.title).toBe('Salesforce Mobile Payments Service LWC Native Capability');
      expect(config.description).toContain('Payments Service');
  ...
  describe('Tool Execution', () => {
    it('should execute successfully and return content', async () => {
      ...
      expect(result.content[0].text).toContain('Payments Service Grounding Context');
    ...
    it('should handle errors gracefully', async () => {
      ...
      expect(result.content).toBeDefined();
      expect(result.content[0].text).toContain('Failed to get payments documentation');
