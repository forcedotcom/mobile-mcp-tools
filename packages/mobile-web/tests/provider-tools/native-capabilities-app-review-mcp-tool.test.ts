...
import { AppReviewMcpTool } from '../../src/provider-tools/native-capabilities-app-review-mcp-tool.js';
...
describe('AppReviewMcpTool', () => {
  let mockTelemetryService: TelemetryService;
  let tool: AppReviewMcpTool;
  ...
  beforeEach(() => {
    ...
    tool = new AppReviewMcpTool(mockTelemetryService);
  });
  ...
  describe('Tool Properties', () => {
    ...
    it('should have correct name', () => {
      expect(tool.getName()).toBe('sfmobile-web-app-review');
    });
  });
  ...
  describe('Tool Execution', () => {
    ...
    it('should handle errors gracefully', async () => {
      ...
      expect(result.content).toBeDefined();
      expect(result.content[0].text).toContain('Failed to get app review documentation');
