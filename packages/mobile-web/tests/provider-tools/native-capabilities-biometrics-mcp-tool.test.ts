...
import { BiometricsMcpTool } from '../../src/provider-tools/native-capabilities-biometrics-mcp-tool.js';
...
describe('BiometricsMcpTool', () => {
  let mockTelemetryService: TelemetryService;
  let tool: BiometricsMcpTool;
  ...
  beforeEach(() => {
    ...
    tool = new BiometricsMcpTool(mockTelemetryService);
  });
  ...
  describe('Tool Properties', () => {
    ...
    it('should have correct name', () => {
      expect(tool.getName()).toBe('sfmobile-web-biometrics');
    });
  });
  ...
  describe('Tool Configuration', () => {
    it('should have correct configuration', () => {
      ...
      expect(config.title).toBe('Salesforce Mobile Biometrics Service LWC Native Capability');
      expect(config.description).toContain('Biometrics Service');
  ...
  describe('Tool Execution', () => {
    it('should execute successfully and return content', async () => {
      ...
      expect(result.content[0].text).toContain('Biometrics Service Grounding Context');
    ...
    it('should handle errors gracefully', async () => {
      ...
      expect(result.content).toBeDefined();
      expect(result.content[0].text).toContain('Failed to get biometrics documentation');
